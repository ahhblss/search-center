...
public abstract class AbstractCanalClient {
    ...
    protected Map<String, BaseCanalDataHandler> dataHandlerMap;
    ...
    private boolean dealEntrys(List<CanalEntry.Entry> entrys) {
        ...
        try {
            for (CanalEntry.Entry entry : entrys) {
                ...
                BaseCanalDataHandler handler = dataHandlerMap.get(getHandlerKey(schemaName, tableName));
                if (handler != null && handler.matchHandler(schemaName, tableName)) {
                    if (handler.handlerData(rowChage.getRowDatasList(), eventType)) {
                        logger.info(("handler success:" + String.format("================> binlog[%s:%s] , name[%s,%s] , eventType : %s",
    ...
    public String getHandlerKey(String schemeName, String tableName) {
    ...
    public Map<String, BaseCanalDataHandler> getDataHandlerMap() {
        return dataHandlerMap;
    }

    public void setDataHandlerMap(Map<String, BaseCanalDataHandler> dataHandlerMap) {
